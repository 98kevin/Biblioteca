 ...
 * @author luedu
 */
public class ReporteporCarrera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableEstadisticas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Estudiante", "Carnet Estudiante", "ID Carrera", "Libro", "Dia de Prestamo", "Total"
            }
        ));
        ...
        jLabel2.setText("Prestamos por Carreras ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 40, 550, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteporCarrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
