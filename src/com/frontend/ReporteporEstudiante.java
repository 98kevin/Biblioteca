 ...
 * @author luedu
 */
public class ReporteporEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableEstadisticas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Carnet Estudiante", "Estudiante", "ID Libro", "Libro", "ID Carrera", "Dia de Prestamo"
            }
        ));
        ...
        jLabel2.setText("Listado Libros Prestados por Estudiante");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, 830, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReporteporEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
