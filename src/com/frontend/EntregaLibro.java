 ...
 * @author luedu
 */
public class EntregaLibro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableEstadisticas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Libro", "Carnet Estudiante", "Estudiante", "Dia de Prestamo", "Entregó", "Total"
            }
        ));
        ...
        jLabel2.setText("Cancelar Libros Prestados");
        ...
        jButtonCancelar.setBackground(new java.awt.Color(255, 255, 51));
        jButtonCancelar.setFont(new java.awt.Font("Arial Black", 0, 22)); // NOI18N
        jButtonCancelar.setText("Pagar");
        jButtonCancelar.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                jButtonCancelarAncestorAdded(evt);
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
            }
        });
        ...
        getContentPane().add(jButtonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 770, -1, -1));
    ...
    private void jButtonCancelarAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_jButtonCancelarAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonCancelarAncestorAdded
    ...
    private void jButtonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarActionPerformed
        ...
        if(jTableEstadisticas.getSelectedRow()==-1){
            ...
            if(JOptionPane.showConfirmDialog(null,"¿Pagar Libro?")==0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EntregaLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
